  ...
  <div className="Landing">
    <section className="App-section is-cover">
      ...
      <div className="App-side is-large">
        <p>
          I am a {JOB}, self-taught, <span className="bold">quick learner</span>
          , passionate about programming and able to{" "}
          <span className="bold">adapt quickly</span> to new enviroments. Know
          more{" "}
          <Link
            className="Link"
            to={ABOUT}
    ...
    <section className="App-section">
      ...
      <div className="App-side is-large">
        ...
        <p>
          I've been coding for <span className="bold">7 years</span> (at least).
        </p>
        <p>
          During this time, I have worked in big (3.000+ employees) and small
          (15 employees) companies.
        </p>
        <p>
          My passion for coding also has pushed me to create several{" "}
          <span className="bold">personal projects</span> during my free time.
        </p>
