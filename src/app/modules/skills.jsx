...
const Skills = () => (
  <div className="Skills">
    <div className="App-section">
      ...
      <p>
        As <span className="bold">{JOB}</span>, I'm able to build web apps, but
        I'm also able to automatize and setup enviroments and proccesses.
      </p>

      <h5 className="Heading Heading--xs">Frontend related</h5>
      <ul className="List List--iconic">
        <li
          className="List-item is-html"
          onClick={() => {
            logClick({
              ...iconTracking,
              label: "HTML"
        ...
        <li
          className="List-item is-javascript"
          onClick={() => {
            logClick({
              ...iconTracking,
              label: "Javascript"
        ...
        <li
          className="List-item is-angular"
          onClick={() => {
            logClick({
              ...iconTracking,
              label: "AngularJS"
        ...
        <li
          className="List-item is-knockout"
          onClick={() => {
            logClick({
              ...iconTracking,
              label: "Knockout"
        ...
        <li
          className="List-item is-backbone"
          onClick={() => {
            logClick({
              ...iconTracking,
              label: "Backbone"
      ...
      <ul className="List List--iconic">
        ...
        <li
          className="List-item is-webpack"
          onClick={() => {
            logClick({
              ...iconTracking,
              label: "Webpack"
      ...
      <ul className="List List--iconic">
        ...
        <li
          className="List-item is-stlyelint"
          onClick={() => {
            logClick({
              ...iconTracking,
              label: "Stylelint"
        ...
        <li
          className="List-item is-jasmine"
          onClick={() => {
            logClick({
              ...iconTracking,
              label: "Jasmine"
        ...
        <li
          className="List-item is-electron"
          onClick={() => {
            logClick({
              ...iconTracking,
              label: "Electron"
    ...
    <div className="App-section">
      ...
      <p>
        If you are curious, this is the enviroment I use to develop at home.
      </p>
      ...
      <p>
        <i>
          * I'm confortable by developing under MacOS (normally in the office I
          use MacOS) and Windows
        </i>
      </p>
    </div>
    ...
    <div className="App-section">
      ...
      <p>
        ...
        social, a <span className="bold">Team member</span>.
      </p>
      <p>
        Having good social skills also helps to develop better and faster, by{" "}
        <span className="bold">asking to workmates</span>,{" "}
        <span className="bold">helping people</span>, or{" "}
        <span className="bold">learning from others</span>.
      </p>
